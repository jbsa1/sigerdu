...
<div class="card mb-3 mb-md-4">
    ...
    <div class="card-body">
        ...
        <div class="mb-3 mb-md-4 d-flex justify-content-between">
            <div class="h3 mb-0">Materi</div>
            <div class="div">
                <a class="btn btn-primary" href="{{ url('/tambah-materi') }}" role="button">Tambah Materi</a>
            </div>
        </div>
        ...
        <div class="table-responsive-xl">
            <table class="table text-nowrap mb-0">
                ...
                <tr>
                    ...
                    <th class="font-weight-semi-bold border-top-0 py-2">Nama Materi</th>
                    <th class="font-weight-semi-bold border-top-0 py-2">Kelas</th>
                    <th class="font-weight-semi-bold border-top-0 py-2">Tanggal Dibuat</th>
                ...
                <tr>
                    <td class="py-3">1</td>
                    <td class="py-3">Permutasi</td>
                    <td class="py-3">Kelas A</td>
                    <td class="py-3">January 15, 2019</td>
                    <td class="py-3">
                        <div class="position-relative">
                            <a class="link-dark d-inline-block" href="{{ url('/edit-materi') }}">
                ...
                <tr>
                    <td class="py-3">2</td>
                    <td class="py-3">Kombinasi</td>
                    <td class="py-3">Kelas B</td>
                    <td class="py-3">January 15, 2019</td>
                    <td class="py-3">
                        <div class="position-relative">
                            <a class="link-dark d-inline-block" href="{{ url('/edit-materi') }}">
                ...
                <tr>
                    <td class="py-3">3</td>
                    <td class="py-3">Regresi Linear</td>
                    <td class="py-3">Kelas C</td>
                    <td class="py-3">January 15, 2019</td>
                    <td class="py-3">
                        <div class="position-relative">
                            <a class="link-dark d-inline-block" href="{{ url('/edit-materi') }}">
