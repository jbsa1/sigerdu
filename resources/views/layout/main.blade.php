...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="grains/img/favicon.ico">


    <!-- DEMO CHARTS -->
    <link rel="stylesheet" href="grains/demo/chartist.css">
    <link rel="stylesheet" href="grains/demo/chartist-plugin-tooltip.css">

    <!-- Template -->
    <link rel="stylesheet" href="grains/graindashboard/css/graindashboard.css">
    ...
    <nav class="navbar flex-nowrap p-0">
        <div class="navbar-brand-wrapper d-flex align-items-center col-auto">
            ...
            <a class="navbar-brand navbar-brand-mobile" href="/">
                <img class="img-fluid w-100" src="grains/img/logo-mini.png" alt="Graindashboard">
            </a>
            <!-- End Logo For Mobile View -->

            <!-- Logo For Desktop View -->
            <a class="navbar-brand navbar-brand-desktop" href="/">
                <img class="side-nav-show-on-closed" src="grains/img/logo-mini.png" alt="Graindashboard" style="width: auto; height: 33px;">
                <img class="side-nav-hide-on-closed" src="grains/img/logo.png" alt="Graindashboard" style="width: auto; height: 33px;">
            </a>
...
<main class="main">
    ...
    <aside id="sidebar" class="js-custom-scroll side-nav">
        <ul id="sideNav" class="side-nav-menu side-nav-menu-top-level mb-0">
            ...
            <li class="side-nav-menu-item">
                <a class="side-nav-menu-link media align-items-center" href="/konten" >
              <span class="side-nav-menu-icon d-flex mr-3">
                <i class="gd-pencil"></i>
              </span>
                    <span class="side-nav-fadeout-on-closed media-body">Konten</span>
                </a>
            </li>

            <li class="side-nav-menu-item">
                <a class="side-nav-menu-link media align-items-center" href="/materi" >
              <span class="side-nav-menu-icon d-flex mr-3">
                <i class="gd-write"></i>
              </span>
                    <span class="side-nav-fadeout-on-closed media-body">Materi</span>
                </a>
            </li>
            <!-- End Documentation -->
        </ul>
        ...
        <footer class="small p-3 px-md-4 mt-auto">
            <div class="row justify-content-between">
                ...
                <div class="col-lg text-center text-lg-right">
                    &copy; Sistem Gim Edukasi Terpadu. All Rights Reserved.
                </div>
            </div>
        </footer>
        <!-- End Footer -->
...
<!-- DEMO CHARTS -->
<script src="grains/demo/resizeSensor.js"></script>
<script src="grains/demo/chartist.js"></script>
<script src="grains/demo/chartist-plugin-tooltip.js"></script>
<script src="grains/demo/gd.chartist-area.js"></script>
<script src="grains/demo/gd.chartist-bar.js"></script>
<script src="grains/demo/gd.chartist-donut.js"></script>
<script>
