            ...
            <div class="row">
                <div class="col-md-6 col-xl-4 mb-3 mb-xl-4">
                    ...
                    <div class="card flex-row align-items-center p-3 p-md-4">
                        ...
                        <div>
                            <h4 class="lh-1 mb-1">150</h4>
                            <h6 class="mb-0">Jumlah pemain</h6>
                        </div>
                ...
                <div class="col-md-6 col-xl-4 mb-3 mb-xl-4">
                    ...
                    <div class="card flex-row align-items-center p-3 p-md-4">
                        ...
                        <div>
                            <h4 class="lh-1 mb-1">170.000</h4>
                            <h6 class="mb-0">Total Jam Permainan</h6>
                        </div>
                ...
                <div class="col-md-6 col-xl-4 mb-3 mb-xl-4">
                    ...
                    <div class="card flex-row align-items-center p-3 p-md-4">
                        ...
                        <div>
                            <h4 class="lh-1 mb-1">50</h4>
                            <h6 class="mb-0">Pemain baru</h6>
                        </div>
                        <i class="gd-arrow-up icon-text d-flex text-success ml-auto"></i>
                    </div>
                    <!-- End Widget -->
